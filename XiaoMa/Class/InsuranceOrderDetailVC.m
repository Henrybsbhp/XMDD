...
@interface InsuranceOrderDetailVC ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)reloadDatasource
{
    ...
    NSString *strprice = [NSString stringWithFormat:@"￥%d", (int)(self.order.policy.premium)];
    self.titles = @[RACTuplePack(@"被保险人：", self.order.policyholder),
                    RACTuplePack(@"车牌号码：", self.order.licencenumber),
                    RACTuplePack(@"证件号码：", self.order.idcard),
