//
//  MutualInsSuspendedAdVC.m
//  XiaoMa
//
//  Created by 刘亚威 on 16/4/19.
...
@interface MutualInsSuspendedAdVC () <SuspendedAdClickDelegate>
...
@implementation MutualInsSuspendedAdVC
...
- (void)viewDidLoad {
    ...
    self.adCtrl = [SuspendedAdVC adVCWithBoundsWidth:self.targetVC.view.frame.size.width * 0.84 targetVC:self.targetVC mobBaseEvent:@"AdvertisementMutualIns"];
...
{
    MutualInsSuspendedAdVC *vc = [[MutualInsSuspendedAdVC alloc] init];
...
-(void)dealloc
{
    DebugLog(@"MutualInsSuspendedAdVC dealloc~~~");
}
