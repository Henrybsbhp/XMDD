...
- (void)shake
{
    [self _shake:10 direction:1 currentTimes:0 withDelta:6 andSpeed:0.08 shakeDirection:ShakeDirectionHorizontal];
}

- (void)shake:(int)times withDelta:(CGFloat)delta
{
	[self _shake:times direction:1 currentTimes:0 withDelta:delta andSpeed:0.055 shakeDirection:ShakeDirectionHorizontal];
}
