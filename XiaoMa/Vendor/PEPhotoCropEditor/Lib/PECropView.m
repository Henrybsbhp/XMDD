...
- (void)commonInit
{
    ...
    self.cropRectView.watermarkText = self.watermarkText;
    self.cropRectView.watermarkTextColor = self.watermarkTextColor;
    self.cropRectView.watermarkTextFont = self.watermarkTextFont;
...
- (void)setWatermarkText:(NSString *)watermarkText
{
    ...
    self.cropRectView.watermarkText = watermarkText;
}

- (void)setWatermarkTextColor:(UIColor *)watermarkTextColor
{
    _watermarkTextColor = watermarkTextColor;
    self.cropRectView.watermarkTextColor = watermarkTextColor;
}

- (void)setWatermarkTextFont:(UIFont *)watermarkTextFont
{
    _watermarkTextFont = watermarkTextFont;
    self.cropRectView.watermarkTextFont = watermarkTextFont;
}
