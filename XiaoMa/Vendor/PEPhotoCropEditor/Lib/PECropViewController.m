...
- (void)loadView
{
    ...
    self.cropView.watermarkText = self.watermarkText;
    self.cropView.watermarkTextColor = self.watermarkTextColor;
    self.cropView.watermarkTextFont = self.watermarkTextFont;
