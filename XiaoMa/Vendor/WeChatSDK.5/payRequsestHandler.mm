...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayWithTradeNo:(NSString *)TradeNO andProductName:(NSString *)pName andPrice:(float_t)price andNotifyUrlStr:(NSString *)urlStr
{
    //订单标题，展示给用户
    ...
    [packageParams setObject: urlStr         forKey:@"notify_url"];  //支付结果异步通知
