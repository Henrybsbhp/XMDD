...
#define SV_IPHONE_OS_VERSION     50000
...
#else
CGFloat SVProgressHUDRingRadius = 14;
CGFloat SVProgressHUDRingThickness = 4;
#endif
...
+ (void)showErrorWithStatus:(NSString *)string after:(NSTimeInterval)after
{
    double delayInSeconds = after;
...
//            if (window.windowLevel == UIWindowLevelNormal && window == gAppDelegate.window) 
            if (window.windowLevel == UIWindowLevelNormal && window == gAppDelegate.window) {
