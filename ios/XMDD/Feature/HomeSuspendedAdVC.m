...
- (void)viewDidLoad {
    ...
    self.adCtrl = [SuspendedAdVC adVCWithBoundsWidth:self.targetVC.view.frame.size.width * 0.84 targetVC:self.targetVC mobBaseEvent:@"xiaomashouye" mobBaseKey:@"shouyetanchuguanggao"];
